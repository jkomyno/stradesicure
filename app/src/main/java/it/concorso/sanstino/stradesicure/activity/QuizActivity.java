...
import it.concorso.sanstino.stradesicure.adapter.CategoryAdapter;
import it.concorso.sanstino.stradesicure.fragment.QuizFragment;
import it.concorso.sanstino.stradesicure.helper.ApiLevelHelper;
import it.concorso.sanstino.stradesicure.helper.ViewUtils;
...
import it.concorso.sanstino.stradesicure.widget.TextSharedElementCallback;
...
public class QuizActivity extends AppCompatActivity {
    ...
    private void populate(String categoryId) {
        ...
        mCategory = StradeSicureDatabaseHelper.getCategoryWith(this, categoryId);
    ...
    private void initLayout(String categoryId) {
        ...
        int resId = getResources().getIdentifier(IMAGE_CATEGORY + categoryId, CategoryAdapter.DRAWABLE,
