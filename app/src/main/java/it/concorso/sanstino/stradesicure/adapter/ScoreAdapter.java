...
public class ScoreAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (quiz.getStringAnswer().equalsIgnoreCase("true")) {
            viewHolder.mAnswerView.setText("Vero");
        } else if (quiz.getStringAnswer().equalsIgnoreCase("false")) {
            viewHolder.mAnswerView.setText("Falso");
        } else {
