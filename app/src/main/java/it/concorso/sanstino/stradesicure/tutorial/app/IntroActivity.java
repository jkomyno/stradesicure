...
import it.concorso.sanstino.stradesicure.tutorial.slide.Slide;
import it.concorso.sanstino.stradesicure.tutorial.slide.SlideAdapter;
import it.concorso.sanstino.stradesicure.tutorial.util.AnimUtils;
import it.concorso.sanstino.stradesicure.tutorial.util.CheatSheet;
import it.concorso.sanstino.stradesicure.tutorial.view.FadeableViewPager;
import it.concorso.sanstino.stradesicure.tutorial.view.InkPageIndicator;
...
public class IntroActivity extends AppCompatActivity {
    private static final String KEY_CURRENT_ITEM =
            "it.concorso.sanstino.stradesicure.tutorial.app.IntroActivity.KEY_CURRENT_ITEM";

    private static final String KEY_SLIDES =
            "it.concorso.sanstino.stradesicure.tutorial.app.IntroActivity.KEY_SLIDES";
