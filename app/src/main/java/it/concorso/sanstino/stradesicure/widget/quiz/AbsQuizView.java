...
import it.concorso.sanstino.stradesicure.activity.QuizActivity;
...
import it.concorso.sanstino.stradesicure.widget.fab.CheckableFab;
...
public abstract class AbsQuizView<Q extends Quiz> extends FrameLayout {
    ...
    private static final int ANSWER_HIDE_DELAY = 1000;
    private static final int FOREGROUND_COLOR_CHANGE_DELAY = 1000;
